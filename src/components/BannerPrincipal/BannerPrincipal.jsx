...
const BannerPrincipal = () => {
  return (
    <div className="flex flex-col items-center max-w-screen-2xl mx-auto">
      ...
      <Link to="/shop" className="rounded-full bg-black text-white text-xl border-2 border-black mt-6 mb-10 px-10 py-2 hover:bg-transparent hover:text-black">Shop</Link>
    </div>
  );
};
